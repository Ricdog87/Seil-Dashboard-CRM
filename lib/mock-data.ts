...
export const investoren: Investor[] = [
  ...
  },
  {
    ...
    ticketMinMio: 8,
    ticketMaxMio: 30,
    assetklassen: ["Einzelhandel", "Nahversorgung"],
    regionen: ["Deutschland"],
...
export const objektInvestorLinks: ObjektInvestorLink[] = [
  ...
  { objektId: "o1", investorId: "i4", status: "angeschrieben", followUpStufe: 2, letzterKontakt: "2026-08-15", naechstesFollowUp: "2026-08-19" },
  ...
  { objektId: "o2", investorId: "i1", status: "angeschrieben", followUpStufe: 2, letzterKontakt: "2026-08-15", naechstesFollowUp: "2026-08-19" },
  { objektId: "o2", investorId: "i2", status: "angeschrieben", followUpStufe: 2, letzterKontakt: "2026-08-12", naechstesFollowUp: "2026-08-17" },
...
export const aktivitaeten: Aktivitaet[] = [
  ...
  { id: "ak04", datum: "2026-07-26T08:00", typ: "system", quelle: "Automatik", text: "Follow-up Stufe 1 automatisch versendet an 5 Kontakte ohne Rückmeldung.", objektId: "o1" },
  ...
  { id: "ak20", datum: "2026-08-12T08:00", typ: "system", quelle: "Automatik", text: "Follow-up Stufe 2 automatisch versendet an Novaris Invest.", objektId: "o2", investorId: "i2" },
  ...
  { id: "ak27", datum: "2026-08-14T08:45", typ: "system", quelle: "Automatik", text: "Investorenliste abgeglichen: 6 passende Profile (Wohnen, 5–40 Mio. €, Rhein-Main/Top-7).", objektId: "o3" },
